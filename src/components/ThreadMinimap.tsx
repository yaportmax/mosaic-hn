...
const styles = StyleSheet.create({ container: { position: 'absolute', right: 2, top: 74, bottom: 14, width: 22, justifyContent: 'center', gap: 1, opacity: 0.82 }, bar: { height: 2, minWidth: 5, borderRadius: 2 } });

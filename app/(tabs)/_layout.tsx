...
export default function TabLayout() {
  ...
  return <Tabs tabBar={(props) => <MosaicTabBar {...props} />} screenOptions={{ headerShown: false, lazy: true, freezeOnBlur: true, sceneStyle: { backgroundColor: theme.tokens.colors.background }, tabBarPosition: 'bottom' }}>
